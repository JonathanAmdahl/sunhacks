    ...
    return (
        <div className='w-screen h-screen px-[10%] py-[10%] bg-[#1E1E1E]'>
            <div className='w-full flex'>
                <div className='w-[calc(100%-5rem)] h-5'></div>
                <div className='w-20 flex gap-4 mb-5'>
                <button onClick={playAndPause} className='w-8 h-8 flex items-center justify-center'>
                    <Image width={20} height={15}   alt='pause' src={PauseIcon}/>
                </button>
                <Link href='/dashboard'><button className='w-8 h-8 flex items-center justify-center'>
                    <Image width={24} height={40} alt='exit' src={XIcon} />
                </button></Link>
                </div>
            </div>
...
>>>>>>> 008d3e967998a1014303a0a467d734ff7da06d0a
        </div>
      </div>
      <div className="w-full h-full flex gap-8">
